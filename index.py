...
@app.route("/language_chart", methods=["GET"])
def language_chart():
    # Sample data for demonstration; replace this with your actual data fetching logic
    data = {
        "Tamil" : 569, "Telugu": 299,"Punjabi":400,"Marati":478,"Gujarati":322,"Bengali":200,"Kannada":250,
        "English": 120,

        "Hindi": 80, "Malayalam":300,"Urudu":300,"Hariyanvi":267,
        "Bojpuri": 50,
        "Rajasthani": 40,
        "Odia": 30,"Assamese":70
    }
    
    return render_template("language_chart.html", data=data)
